...
for (const layout of [
  ...
  test.describe(`arrow controls in ${layout.theme} ${layout.locale}`, () => {
    ...
    test(`@browser-smoke dashboard choices use accessible arrows`, async ({ page }) => {
      await page.goto("/");
    ...
    test(`@browser-smoke drill presets use accessible arrows`, async ({ page }) => {
    ...
    test(`@browser-smoke case modules use accessible arrows`, async ({ page }) => {
    ...
    test(`@browser-smoke content-pack back control uses accessible arrows`, async ({ page }) => {
    ...
    test(`@browser-smoke question ranking controls use accessible arrows`, async ({ page }) => {

...
Status: All six fixes pushed independently. Integration found missing translations for the new Download label and an early language-selection test race; follow-up corrections are under verification. Native screen-reader and real-device assessments remain pending.

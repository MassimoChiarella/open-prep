...
**30 confirmed issues: 8 P1, 19 P2, 3 P3. Six improvements are tracked separately. All are now implemented and verified.** Reviewed commit `9d25cbe82489bdaaa5678ea7fecd12962f236fb8` on `main`. This records the original audit, with historical source links pinned to that commit. The completed 13-step plan, incremental commits, supported limits and validation are maintained in [DEVELOPMENT_PLAN.md](DEVELOPMENT_PLAN.md).
...
**Remediation validation:** final implementation `39cb9e2` passed 1,232 unit/component tests, 178 Chromium tests and 103 Firefox/WebKit/backup-portability tests, plus strict TypeScript, lint, content/locale contracts, production build, artifact-integrity and performance gates. The results below describe the original pre-repair audit, not the final implementation.
...
- Location: [src/features/case-practice/fit/FitPracticeView.tsx:745–763](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/case-practice/fit/FitPracticeView.tsx#L745); usages lines 715–720.
...
- Location: [src/features/drills/ActiveDrillSession.tsx:359](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/ActiveDrillSession.tsx#L359), `:380`, `:585`, `:671`.
...
- Primary location: [src/features/exhibits/ExhibitChartRenderer.tsx:82](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/exhibits/ExhibitChartRenderer.tsx#L82); value-list loop at lines 340–366.
- Callers: [src/features/exhibits/ExhibitQuestionFlow.tsx:166–170](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/exhibits/ExhibitQuestionFlow.tsx#L166), [src/features/exhibits/ExhibitSprint.tsx:399–403](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/exhibits/ExhibitSprint.tsx#L399), and chart-based imported full cases.
...
- Location: [src/features/questions/arithmeticQuestionGenerator.ts:365](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/questions/arithmeticQuestionGenerator.ts#L365), `:393`, `:520`; [src/lib/format.ts:8](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/lib/format.ts#L8).
...
- Location: [src/data/exhibits/exhibitDatasets.ts:837–853](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/data/exhibits/exhibitDatasets.ts#L837), especially `answer.value: 0.04` at line 843.
...
- Location: [src/features/drills/ActiveDrillSession.tsx:505](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/ActiveDrillSession.tsx#L505), `:571`; [src/features/drills/drillTimer.ts:100-102](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/drillTimer.ts#L100); [src/features/scoring/scoringEngine.ts:62](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/scoring/scoringEngine.ts#L62).
...
- Location: [src/lib/validation/validateAnswer.ts:134-135](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/lib/validation/validateAnswer.ts#L134); example authored prompt [src/data/questionTemplates/caseStyleTemplates.ts:48](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/data/questionTemplates/caseStyleTemplates.ts#L48); scoring [src/features/drills/interviewMathEvaluation.ts:74](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/interviewMathEvaluation.ts#L74).
...
- Location: [src/features/exhibits/exhibitFormatting.ts:12–22,65–77,93–106](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/exhibits/exhibitFormatting.ts#L12).
...
- Location: [src/features/drills/ActiveDrillSession.tsx:137](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/ActiveDrillSession.tsx#L137), `:359`; draft shape [src/features/drills/drillPersistence.ts:79](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/drillPersistence.ts#L79).
...
- Location: [src/features/case-practice/fit/FitPracticeView.tsx:147–167](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/case-practice/fit/FitPracticeView.tsx#L147), especially line 151.
...
[src/features/question-packs/QuestionPackDrillSession.tsx:104](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/question-packs/QuestionPackDrillSession.tsx#L104); [src/features/drills/drillPersistence.ts:30](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/drillPersistence.ts#L30) and `:46`. The direct-pack loader passes no draftKeyScope; its route and settings encode pack ID/difficulty/count but no packVersion/importedAt. Open an incomplete version-1 pack drill, replace the installed pack with version 2 changing its questions but retaining count/categories, and open the same direct link. The newly generated version-2 session has the same draft key, so ActiveDrillSession loads the old questions and answer key. Verified a pure persistence probe: new session asks 3+3, but its computed draft key matches v1 and loads 1+1. The pool loader already scopes drafts by pack version/import timestamp. Reuse that scope for direct packs and test replacement/import of the same version as well.

### BUG-19 — P2: Mixed Daily Workouts record beginner work as expert personal bests

- Location: [src/features/progress/personalBests.ts:108](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/progress/personalBests.ts#L108), `:122`; source mix [src/features/drills/dailyWorkout.ts:97](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/drills/dailyWorkout.ts#L97), `:161`.
...
- Location: [src/data/questionTemplates/starterTemplates.ts:721](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/data/questionTemplates/starterTemplates.ts#L721), `:737`; permissive legacy match [src/lib/validation/validateAnswer.ts:54](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/lib/validation/validateAnswer.ts#L54).
...
- Location: [src/lib/parser/parseAnswer.ts:256](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/lib/parser/parseAnswer.ts#L256), `:276`; app locale formatting [src/features/i18n/I18nProvider.tsx:142](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/i18n/I18nProvider.tsx#L142).
...
- Location: [src/lib/math/formulaEvaluator.ts:28-36](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/lib/math/formulaEvaluator.ts#L28).
...
- Location: [src/features/market-sizing/marketSizingScoring.ts:220–225](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/market-sizing/marketSizingScoring.ts#L220); validator [src/features/question-packs/questionPackMarketSizing.ts:294–295](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/question-packs/questionPackMarketSizing.ts#L294) permits finite fractional maxPoints.
...
- Confirmed location: [src/features/exhibits/ExhibitQuestionFlow.tsx:376–381](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/exhibits/ExhibitQuestionFlow.tsx#L376); reset/select paths lines 57–64,93–102,116–119,180–186 remain available while awaiting persistence.
...
- Location: [src/features/formulas/formulaFilters.ts:22](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/formulas/formulaFilters.ts#L22), `:90`; related tests [src/tests/unit/formulaFilters.test.ts:31](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/tests/unit/formulaFilters.test.ts#L31).
...
- Beginner CAGR and Rule of 72 templates already exist in [src/data/questionTemplates/growthTemplates.ts:98](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/data/questionTemplates/growthTemplates.ts#L98) and `:215`. The override and growth-tag blacklist are stale, and the existing test asserts the incorrect mapping.
...
- Location: [src/features/questions/arithmeticQuestionGenerator.ts:495](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/questions/arithmeticQuestionGenerator.ts#L495); uniqueness gate [src/features/questions/questionGenerator.ts:137](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/questions/questionGenerator.ts#L137).
...
[src/features/settings/LocalSettingsView.tsx:544](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/settings/LocalSettingsView.tsx#L544) and `:992` (also private preview at `:914`). Clear-data previews load at mount and are updated only by clear operations. Import/restore/reset handlers never refresh those counts. Starting with an empty Settings page and successfully importing a saved settings record leaves Clear All confirmation disabled and the page claiming there is no saved data. Verified alongside the import race probe: IndexedDB contains the imported record but the clear-all checkbox stays disabled. Complete restores that add personal records likewise leave personal-clear counts stale. Recompute inventories after successful mutations or invalidate/remount Settings.

### BUG-28 — P3: Formula validation accepts malformed infix expressions

- Location: [src/lib/math/formulaEvaluator.ts:122-130](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/lib/math/formulaEvaluator.ts#L122); pack validation [src/features/question-packs/questionPackTemplate.ts:585](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/question-packs/questionPackTemplate.ts#L585).
...
- Location: [src/features/questions/variableResolver.ts:37](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/questions/variableResolver.ts#L37); repeated capacity arithmetic [src/features/questions/questionGenerator.ts:198](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/questions/questionGenerator.ts#L198); representative checks [src/features/question-packs/questionPackTemplate.ts:615](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/question-packs/questionPackTemplate.ts#L615).
...
- Location: [src/features/case-practice/questioning/questioningScoring.ts:421–424](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/features/case-practice/questioning/questioningScoring.ts#L421).
...
The descriptions below preserve the original recommendations. All six are implemented; the commit and test ledger is in [DEVELOPMENT_PLAN.md](DEVELOPMENT_PLAN.md).

| ID | Implemented outcome | Delivery step |
|---|---|---|
| IMP-01 | ROI prompts and Formula Library examples consistently distinguish total proceeds from net gain | 08 |
| IMP-02 | Save-only retries preserve completed attempts, IDs, timestamps and reviewed scores across persistence failures | 06, 07, 11 |
| IMP-03 | Optional private full-case drafts support validated resume/discard, backup/clear scope, pending-write protection and keyboard focus recovery | 09, 11, 13 |
| IMP-04 | Independent arithmetic, visible-evidence, locale, timer and async-order regression checks accompany the repairs | 04–12 |
| IMP-05 | Arrow/navigation smoke coverage is split into independent route journeys with the existing time limits and zero retries | 12 |
| IMP-06 | Prep-plan copy explains that target firms are reference notes | 11 |

- **IMP-01 — Clarify ROI wording.** [businessTemplates.ts](https://github.com/MassimoChiarella/open-prep/blob/9d25cbe82489bdaaa5678ea7fecd12962f236fb8/src/data/questionTemplates/businessTemplates.ts#L256) calls the total proceeds a “gain” but subtracts the original investment again. Say “total return including the initial investment” if that is intended, or use net gain consistently. Align the Formula Library example too. Resolve wording before changing the numerical answer key.
...
The original unconfirmed follow-ups were investigated during remediation. Completion retries now avoid repeated review bookkeeping; controlled IndexedDB event tests cover open rejection, late success after a blocked open, and reopening after version changes; partial preference-clear failures still invalidate stale writers. Related case-module save races and save-only retries were repaired. Final review also reproduced and fixed a queued drill-write race after reset, with separate tests proving ordinary navigation still saves. Real browser tests cover reset/import invalidation and offline recovery; the injected IndexedDB connection failures use unit harnesses, not browser-engine fault injection. A suspicion about ordinary unvisited routes failing after a warmed install was tested and not confirmed.

...
# Open Prep Complete AI Authoring Bundle: Fixed Numeric

Bundle revision: **2026-08-29**

This one Markdown attachment is self-contained for `kind: "fixed_numeric"`. The package family is already resolved. Give this file and the user's authorized source material to the LLM; no second guide, schema, or example attachment is needed.
...
Generated from `math-drill-ai-pack-authoring-start.md`, `math-drill-ai-pack-fixed-numeric-kit.md`, and the named canonical JSON assets.
...
## Focused family module: Fixed Numeric

<!-- BEGIN AUTHORING COMPONENT: math-drill-ai-pack-fixed-numeric-kit.md -->
...
<!-- END AUTHORING COMPONENT: math-drill-ai-pack-fixed-numeric-kit.md -->
...
<!-- BEGIN EMBEDDED FILE: question-pack-starter.mathdrill.json -->
```json
{
  "format": "math-drill-question-pack",
  "schemaVersion": 2,
...
```
<!-- END EMBEDDED FILE: question-pack-starter.mathdrill.json -->

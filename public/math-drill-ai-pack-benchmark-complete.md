...
# Open Prep Complete AI Authoring Bundle: Benchmarks

Bundle revision: **2026-08-29**

This one Markdown attachment is self-contained for `kind: "benchmark"`. The package family is already resolved. Give this file and the user's authorized source material to the LLM; no second guide, schema, or example attachment is needed.
...
Generated from `math-drill-ai-pack-authoring-start.md`, `math-drill-ai-pack-benchmark-kit.md`, and the named canonical JSON assets.
...
## Focused family module: Benchmarks

<!-- BEGIN AUTHORING COMPONENT: math-drill-ai-pack-benchmark-kit.md -->
...
<!-- END AUTHORING COMPONENT: math-drill-ai-pack-benchmark-kit.md -->
